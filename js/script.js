let sentenceArray = [
    '希望是帆，理想是船，我们是水手。我们信奉勇气、智慧、思想、信念;我们追求勤劳、勇敢、诚实、善良;我们最重要的事业是学习，我们最现实的目标是xx年的辉煌。',
    '眼泪不是我们的答案，拼搏才是我们的选择。',
    '每天都是一个起点，每天都有一点进步，每天都有一点收获！',
    '拼一载春秋，搏一生无悔。',
    '潮湿的火柴划不出生命的焰;残损的小帆，驶不出大海的波澜;今天是一个用努力改写的梦幻;明天是一个用梦想编织的花环;枯藤能挥出美丽的孤线;努力能闪出成功的誓言;把握今天，拥抱未来!',
    '拧成一股绳，搏尽一份力，狠下一条心，共圆一个梦。',
    '贵在坚持、难在坚持、成在坚持',
    '把汗水变成珍珠，把梦想变成现实！',
    '少年狂，我自强。挥斥方遒斗志昂，披荆斩棘神飞扬;渺挫折，笑风浪。恣意青春我最狂，冲刺巅峰我最棒;剑出鞘，亮锋芒。沙场点兵我为王，决战高考我辉煌。',
    ...
    '潮湿的火柴划不出生命的焰；残损的小帆，驶不出大海的波澜；今天是一个用努力改写的梦幻；明天是一个用梦想编织的花环；枯藤能挥出美丽的孤线；努力能闪出成功的誓言；把握今天，拥抱未来！',
    '用激情创造未来，用热血拼搏现在，把一切献给现在，创造美好未来。点燃激情，放飞梦想，踏书山坎坷，劈波斩浪，集胸中豪情，倾热血满腔，书生自有凌云志，书生自有壮志酬。选择了大海就要乘风破浪，选择了蓝天就要展翅飞翔，请相信没有比人更高的山峰，没有比脚更长的路。',
    '选择了大海，就去乘风破浪;选择了蓝天，就去展翅翱翔;选择了高三，就去全力以赴。行动，行动，行动是最好的誓言。百炼成钢，百日流芳，我们，注定成功!我们，必将辉煌!',
    '我们来自不同的地方;却因梦想而聚在这里;我们共同奋斗，共同努力，只为明天更加美丽;我们团结勤奋;我们自强不息;我们要对得起自己;每天带着希望而来;揣着收获而归;我们相信明天会更完美!',
